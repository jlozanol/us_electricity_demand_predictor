"""
Streamlit app showcasing a modular pipeline for time series forecasting — from feature generation
and model loading to prediction and interactive visualization.
This app allows users to explore electricity demand predictions across U.S. EIA regions,
comparing real-time data, EIA forecasts, and custom ML model predictions.

Author: Jorge Lozano
Email: jlozanol@protonmail.com
GitHub: https://github.com/jlozanol
LinkedIn: https://www.linkedin.com/in/jorgelozanol
...
def process_single_region(
	...
	try:
		...
		if 'timestamp_ms' in region_features.columns:
			...
			st.warning(f'   - Missing timestamp_ms in features for {region_name}')
	...
	try:
		...
		if 'prediction_results' in st.session_state:
			...
			if selected_region != '---':
				...
				plot_hourly_demand_temprature(selected_region, prediction_dfs)
				...
				st.dataframe(
					metrics_df.style.format(precision=2), use_container_width=True
				)
		...
		📧 [jlozanol@protonmail.com](mailto:jlozanol@protonmail.com)  
		🔗 [LinkedIn](https://www.linkedin.com/in/jorgelozanol)  
		💻 [GitHub](https://github.com/jlozanol)
		""")
